    ...
    (() => {
        ...
        r.VantaBase = class {
            ...
            applyCanvasStyles(e, t = {}) {
                Object.assign(e.style, { position: "absolute", zIndex: -1, top: 0, left: 0, background: "", transition: "transform 0.3s" }), Object.assign(e.style, t), e.classList.add("vanta-canvas");
            }
            initThree() {
                n.WebGLRenderer ?
